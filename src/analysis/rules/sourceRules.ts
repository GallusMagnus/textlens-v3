...
const sourceRuleSpecs: Record<string, RuleSpec> = {
  maaz_protocol: {
    ...
    allowedModes: [],
    analyticalUse:
      "Use only through the dedicated MAAZ mode branch for standalone antizionism classification and public advocacy response.",
    triggerSignals: [
      "Colonizer, apartheid or genocide libel",
      "Zionist-for-Jew substitution in conspiratorial or exclusionary rhetoric",
      "Institutional litmus tests or purges targeting Zionism",
      "Tokenization of anti-Zionist Jewish figures as a shield",
      "Eliminationist slogans or demands directed at Israel's existence",
    ],
    guardrailSignals: [
      "MAAZ mode does not apply IHRA, JDA, Nexus or TextLens protected-speech guardrails.",
    ],
    extraLimits: [
      "Do not use this source in the shared staged taxonomy engine; MAAZ reports are generated by the dedicated MAAZ mode branch.",
    ],
  },
  decoding_antisemitism_2024: {
    section: "Validated Antisemitism Ontologies",
    usageKind: "framework",
    clausePrefixes: ["DA"],
    allowedModes: [
    ...
    analyticalUse:
      "Use as a source-faithful ontology for identifying communicated antisemitic meaning by separating concept content from expression form, documenting inference chains and abstaining when coherent non-antisemitic readings remain.",
    triggerSignals: [
      "Classic concepts: other/foreign, evil/devil, blood libel or child murder, dehumanisation, immorality, lie and deceit, vengefulness, disloyalty, blame for antisemitism",
      "Power concepts: greed, exploitation, capitalism identification, overwhelming power, conspiracy theories, disintegration and self-victimisation",
      "Secondary antisemitism: rejection of guilt, clean-break demands, Holocaust denial or distortion, denial or relativisation of antisemitism, instrumentalisation of antisemitism or the Holocaust, Nazi-Jewish collaboration, admonishers, taboo of criticism, Jews have not learned from the past",
      "Post-Holocaust categories: collective responsibility for Israel, Jewish privilege or free pass, affirmation of Nazis, Hitler or the Holocaust",
      "Israel-related categories: Nazi or fascism analogies, apartheid or racist-state analogy, colonialism analogies, terrorist state, genocide, double standards, denial of Israel's right to exist, BDS or general boycott support, Israel's sole guilt in the conflict",
      "Aggressive speech acts: antisemitic insults, threats, curses, death wishes and affirming, desiring or calling for violence",
      "Implicit forms: code words, detour communication, presupposition, metaphor, allusion, wordplay, rhetorical questions, irony, memes or multimodal cues",
    ],
    guardrailSignals: [
      "Do not infer speaker identity, motive or intent; analyse communicated meaning in context.",
      "If at least one coherent non-antisemitic interpretation remains, classify conservatively as not established or protected by a guardrail.",
      "Specific, concrete, time-bounded or spatially limited claims are less likely to be antisemitic than generalised or essentialised claims.",
      "Do not treat factual error, harshness, emotional language or ordinary political criticism as antisemitic without the source's concept criteria being met.",
      "When used outside Decoding Antisemitism Mode, mark contested Israel-related categories as source-specific or advisory unless other active sources also support the finding.",
    ],
    extraLimits: [
      "In Decoding Antisemitism Mode, this is the sole governing source.",
      "In other modes, use this source only through the explicit crosswalk and the selected mode policy; it does not replace the TextLens taxonomy, IHRA, JDA, Nexus, legal, media or publication standards.",
      "Treat apartheid analogy, BDS support, genocide accusation, double standards, colonialism analogy and denial of Israel's right to exist as high-review boundary categories when other mode guardrails differ.",
    ],
  },
  ihra: {
